...
//  ChatApp
//
//  Created by Тимур Таймасов on 22.11.2021.
//
...
/// UICollectionViewLayout, который высчитывается в зависимости от высоты ячейки
...
class PinterestLayout: UICollectionViewLayout {
    ...
    // MARK: - Initializers
    init(numberOfColumns: Int, spacing: CGFloat) {
        self.numberOfColumns = numberOfColumns
        self.cellPadding = spacing
        super.init()
    }
